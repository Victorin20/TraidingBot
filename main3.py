...
path = "C:/Users/victo/Downloads/file3.txt"
...
while failed == False and succes == False:
    ...
    if(failed == False):
        ...
        if(last_price <= startPrice - points*2 and third == False and second_active):    
            sellStop(2, volume*4)
            third = True

        if(last_price <= startPrice - points*3 and fourd == False and third_active):
            buyLimit(3, volume*8)
            fourd = True
        
        if(last_price >= startPrice - points*2 and fifth == False and fourd_active):
            sellStop(2, volume*16)
            fifth = True
        
        if(last_price <= startPrice - points * 3 and sixth == False and fifth_active):
